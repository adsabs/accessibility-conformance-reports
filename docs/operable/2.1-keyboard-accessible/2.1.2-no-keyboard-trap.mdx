...
<Project name="scix">
  <PartialSupport>
    <p>The year histogram filter is not easy to get out of, especially when search results covers large number of years.</p>
    <p>Viz -> Results Graph, once focus on the individual dot on the graph, cannot skip out of the graph.</p>
  </PartialSupport>
</Project>
